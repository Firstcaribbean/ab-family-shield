...
const linkedParents: LinkedParent[] = [
  {
    id: "guardian_2",
    name: "Elena Rivera",
...
const latestLocations: Record<string, LocationPoint> = {
  child_1: {
    id: "loc_1",
    childId: "child_1",
    latitude: 34.0602,
...
const locationHistory: Record<string, LocationPoint[]> = {
  child_1: [
    {
      id: "loc_1a",
      childId: "child_1",
...
const screenTimeRules: ScreenTimeRule[] = [
  {
    id: "rule_1",
    childId: "child_1",
    name: "Study Mode",
...
const browsingRules: BrowsingRule[] = [
  {
    id: "browse_rule_1",
    childId: "child_1",
...
const browsingLogs: BrowsingLog[] = [
  {
    id: "blog_1",
    childId: "child_2",
...
export const deviceLinkInvites: DeviceLinkInvite[] = [
  {
    childId: "child_1",
    code: "AVA-2048",
